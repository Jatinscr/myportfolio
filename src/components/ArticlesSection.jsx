function ArticlesSection() {
  return (
    <section className="max-w-5xl p-6 ml-52">
      <h2 className="text-4xl font-normal mb-12 text-gray-700 ">Articles</h2>

      {/* CARD 1 */}
      <ArticleCard
        title="Case Study: Project Management for DIY Enthusiasts"
        titleClass="text-3xl font-normal text-gray-800 mb-5"
        category="Side Projects"
        categoryStyle="border border-gray-700 text-gray-700 w-31 h-8 flex items-center justify-center mb-3"
        date="16 February 2025"
        dateClass="text-slate-500 text-lg mb-3"
        time="3 minute read"
        timeClass="text-slate-500 text-lg mb-3"
        ...
        descriptionClass="text-gray-500 leading-relaxed text-lg"
        link="#"
        linkText="Read Article"
        linkClass="text-sky-600 text-lg"
      />
      ...
      <ArticleCard
        ...
        titleClass="text-3xl font-normal text-gray-800 mb-5"
        category="Life"
        categoryStyle="border border-gray-700 text-gray-700 "
        date="31 August 2024"
        dateClass="text-slate-500 text-lg mb-1"
        time="1 minute read"
        timeClass="text-slate-500 text-lg mb-1"
        ...
        link="#"
        linkText="Read Article"
        linkClass="text-sky-600 text-lg font-light"
      />
      ...
      <ArticleCard
        ...
        titleClass="text-3xl font-normal text-gray-800 mb-5"
        category="Laravel"
        categoryStyle="border border-red-400 text-red-500 h-7"
...
function ArticleCard({
  ...
  description,
  descriptionClass = "text-gray-600",  // ✅ Default description style
  link,
  linkText = "Read Article",
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap items-center gap-3 text-sm mb-3">
        <span className={`rounded-full px-3 py-0.5 ${categoryStyle}`}>
          {category}
        </span>
      ...
      <p className={`${descriptionClass} mb-3`}>{description}</p>
